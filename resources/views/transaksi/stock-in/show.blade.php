...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-semibold text-gray-800 dark:text-white">Detail Stok Masuk</h1>
    ...
    <div class="bg-white dark:bg-gray-900 rounded-3xl p-6 shadow-sm border border-gray-100 dark:border-gray-700">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
                ...
                <p class="font-semibold text-gray-800 dark:text-white">Rp {{ number_format($totalAmount, 0, ',', '.') }}</p>
            </div>
        </div>
            ...
            <table class="w-full min-w-full">
                ...
                <tfoot>
                    <tr class="bg-gray-50 dark:bg-gray-800 font-semibold">
                        ...
                        <td class="px-4 py-3">{{ number_format($totalQuantity, 0, ',', '.') }}</td>
                        <td class="px-4 py-3"></td>
                        <td class="px-4 py-3">Rp {{ number_format($totalAmount, 0, ',', '.') }}</td>
