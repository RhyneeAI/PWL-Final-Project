...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white dark:bg-gray-900 rounded-3xl shadow-sm border border-gray-100 dark:border-gray-700 p-8">
        <div class="mb-8">
            ...
            <p class="text-gray-500 dark:text-gray-400 mt-1">Tambahkan kategori produk baru.</p>
        </div>
        ...
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <div class="mt-6">
                ...
                <textarea name="description" rows="4"
                    class="w-full rounded-xl border border-gray-300 dark:border-gray-700 px-4 py-3 bg-white dark:bg-gray-800 text-gray-800 dark:text-white">{{ old('description') }}</textarea>
            </div>
