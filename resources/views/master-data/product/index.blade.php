    ...
    <div class="space-y-6 min-h-full">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400">Kelola semua produk di sini.</p>
            </div>
                ...
                <table class="w-full min-w-full">
                    ...
                    <tbody class="divide-y divide-gray-200 dark:divide-gray-700 text-white">
                        <tr class="product-row hover:bg-gray-50 dark:hover:bg-gray-800">
                            <td class="px-6 py-5">Laptop ASUS</td>
                            <td class="px-6 py-5">Rp 12.000.000</td>
                        ...
                        <tr class="product-row hover:bg-gray-50 dark:hover:bg-gray-800">
                            <td class="px-6 py-5">Mouse Logitech</td>
                            <td class="px-6 py-5">Rp 250.000</td>
                            <td class="px-6 py-5">50</td>
                            <td class="px-6 py-5">Aksesoris</td>
                            <td class="px-6 py-5 text-center space-x-2">
                                <button class="px-3 py-1 bg-blue-500 text-white rounded-lg text-xs">Edit</button>
                                <button class="px-3 py-1 bg-red-500 text-white rounded-lg text-xs">Hapus</button>
                            </td>
                        ...
                        <tr class="product-row hover:bg-gray-50 dark:hover:bg-gray-800">
                            <td class="px-6 py-5">Wireless Headphone</td>
                            <td class="px-6 py-5">Rp 1.250.070</td>
                        ...
                        <tr class="product-row hover:bg-gray-50 dark:hover:bg-gray-800">
                            <td class="px-6 py-5">Smart Watch Series 8</td>
                            <td class="px-6 py-5">Rp 790.060</td>
                            <td class="px-6 py-5">20</td>
                            <td class="px-6 py-5">Wearable</td>
                            <td class="px-6 py-5 text-center space-x-2">
                                <button class="px-3 py-1 bg-blue-500 text-white rounded-lg text-xs">Edit</button>
                                <button class="px-3 py-1 bg-red-500 text-white rounded-lg text-xs">Hapus</button>
                            </td>
                        ...
                        <tr class="product-row hover:bg-gray-50 dark:hover:bg-gray-800">
                            <td class="px-6 py-5">Mechanical Keyboard</td>
                            <td class="px-6 py-5">Rp 80.270</td>
                            <td class="px-6 py-5">40</td>
                            <td class="px-6 py-5">Gaming</td>
                            <td class="px-6 py-5 text-center space-x-2">
                                <button class="px-3 py-1 bg-blue-500 text-white rounded-lg text-xs">Edit</button>
                                <button class="px-3 py-1 bg-red-500 text-white rounded-lg text-xs">Hapus</button>
                            </td>
                        ...
                        <tr class="product-row hover:bg-gray-50 dark:hover:bg-gray-800">
                            <td class="px-6 py-5">Monitor Xiaomi G24i 144Hz</td>
                            <td class="px-6 py-5">Rp 1.619.900</td>
